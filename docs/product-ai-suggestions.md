...
- Si la marca o categoría están vacías y la IA devuelve valores, se rellenan automáticamente.
...
- El frontend asume que la respuesta contiene `brand`, `category`, `confidence` y `source`.
