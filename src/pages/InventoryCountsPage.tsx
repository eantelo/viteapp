...
const statusLabels: Record<InventoryCountStatus, string> = { Draft: "En curso", Completed: "Completada", Cancelled: "Cancelada" };
const statusVariants: Record<InventoryCountStatus, "default" | "secondary" | "outline"> = { Draft: "default", Completed: "secondary", Cancelled: "outline" };
          ...
          <Card>
            <CardHeader className="gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <Select value={status} onValueChange={(value: string) => setStatus(value as InventoryCountStatus | "all")}>
                ...
                <SelectContent><SelectItem value="all">Todos los estados</SelectItem><SelectItem value="Draft">En curso</SelectItem><SelectItem value="Completed">Completadas</SelectItem><SelectItem value="Cancelled">Canceladas</SelectItem></SelectContent>
              </Select>
            </CardHeader>
            <CardContent>
